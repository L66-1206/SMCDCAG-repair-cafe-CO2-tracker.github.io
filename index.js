...
var carbonData = {
  ...
  leather: {
    Shirt : { co2: 2, averageWeight: 0.2 },
    Jeans: { co2: 35, averageWeight: 0.7 },
    Hoodie: { co2: 15, averageWeight: 0.7 },
    Knapsack: { co2: 10, averageWeight: 0.5 },
    Coat: { co2: 25, averageWeight: 1.5 },
    Leotard: { co2: 5, averageWeight: 0.3 },
    Jacket: { co2: 20, averageWeight: 1 },
    Dress: { co2: 15, averageWeight: 0.5 },
    Trousers: { co2: 20, averageWeight: 0.7 },
    Jumper: { co2: 10, averageWeight: 0.4 },
    Hat: { co2: 2, averageWeight: 0.1 },
    Vest: { co2: 5, averageWeight: 0.2 },
    Glove: { co2: 1, averageWeight: 0.1 },
    Curtain: { co2: 25, averageWeight: 2 },
